...
- Select one item from `16-experiments/approved/`.
...
- Start an experiment found only in `16-experiments/backlog/`.
...
3. Otherwise select the oldest experiment in `16-experiments/approved/`.
